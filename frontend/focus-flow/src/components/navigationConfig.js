export const navItems = {
  ...
  teacher: [{ id: 'home', ic: 'home', label: 'Dashboard' }, { id: 'courses', ic: 'film', label: 'Course Videos' }, { id: 'upload', ic: 'up', label: 'Upload' }, { id: 'reviewShorts', ic: 'play', label: '短影片審核' }],
...
export const topbarMap = {
  ...
  teacher: { home: ['Dashboard', '管理課程與影片'], courses: ['Course Videos', '已上傳影片清單'], upload: ['Upload Video', '影片上傳後自動建立 AI 索引'], reviewShorts: ['短影片審核頁', '審核 AI 生成短影片是否通過'], profile: ['個人資料', '管理帳號資訊'] },
