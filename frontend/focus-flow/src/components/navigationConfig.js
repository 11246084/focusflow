export const navItems = {
  ...
  admin:   [{ id: 'home', ic: 'home', label: '系統總覽' }, { id: 'users', ic: 'users', label: '使用者' }, { id: 'courses', ic: 'book', label: '課程' }, { id: 'videos', ic: 'film', label: '影片' }, { id: 'stats', ic: 'bar', label: '使用統計' }],
};
...
export const topbarMap = {
  ...
  admin:   { home: ['系統總覽', '監控整體系統運作'], users: ['使用者管理', '學生 / 教師帳號'], courses: ['課程管理', '課程新增 / 編輯 / 刪除'], videos: ['影片管理', '全系統影片管理'], stats: ['使用統計', '使用紀錄統計'], profile: ['個人資料', '管理帳號資訊'] },
};
