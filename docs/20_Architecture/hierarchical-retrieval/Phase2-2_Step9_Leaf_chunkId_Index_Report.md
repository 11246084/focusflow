...
?? docs/00_Deliverables/Contest/            （本次工作前即存在的 untracked 目錄）
```

執行前 working tree 除 `docs/00_Deliverables/Contest/` 外乾淨，HEAD 為 `07c8898`。未執行任何 reset / clean / restore / rebase / merge。
