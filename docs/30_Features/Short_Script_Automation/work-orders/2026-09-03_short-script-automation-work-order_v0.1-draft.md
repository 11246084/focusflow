...
> **本文件是草案，不得作為開工依據。**
>
> 依 [施工單目錄說明](../../Student_Pilot_Backend/work-orders/work-order_README.md)：「若規格仍有未決事項，施工單只能標記為草案，不得作為開工依據。」
>
> **2026-09-03 更新**：[規格書 v0.9 草案](../specs/2026-09_Short_Script_Automation_Spec.md) 已產出，原第 8.2 節的 D-01～D-07 全數轉為規格書的定案項目 DR-01～DR-15 或待決項目 P-02～P-04。本施工單的範圍與驗收條件一律以規格書為準；規格書升 v1.0 Frozen 後，本施工單方可核准開工。

| 項目 | 內容 |
| --- | --- |
| 產出日期 | 2026-09-03 |
| 基準文件 | [短影片腳本自動化規格書 v0.9 草案](../specs/2026-09_Short_Script_Automation_Spec.md)（2026-09-03） |
...
- [ ] [規格書](../specs/2026-09_Short_Script_Automation_Spec.md) 已升 v1.0 Frozen，且簽核欄已填寫
...
現況是人工流程：組員手動查資料庫、挑片段、寫腳本，已產出兩份範例與一份空白模板（`docs/30_Features/Short_Video/teacher-avatar-track/`）。本輪要把其中可重複的部分自動化。
...
- **不修改** `docs/30_Features/Short_Video/teacher-avatar-track/` 底下的 V4、V5 與空白模板。使用者 2026-09-03 決定：先做自動化，腳本模板之後才套用。（**2026-09-10 使用者撤回**：模板已整併，見規格書附錄 H.3、H.4）
...
比對結果存入 `docs/30_Features/Short_Script_Automation/evidence/`。
...
1. ~~不得修改 `docs/30_Features/Short_Video/teacher-avatar-track/` 的任何檔案（使用者 2026-09-03 決定）。~~ 2026-09-10 使用者撤回，見規格書附錄 H.3。
...
- **teacher-avatar-track 未收進 README**：與 `docs/30_Features/Short_Video/` 的十支體系（v8，含 G1／G2／G3 驗證閘、共用配樂、統一調色）分岔。本輪不處理。（2026-09-10 已整併，教師數位分身收為手法 10）
...
| 原編號 | 議題 | 現況 |
| --- | --- | --- |
| D-01 | 是否先立規格書 | 已產出 [規格書 v0.9 草案](../specs/2026-09_Short_Script_Automation_Spec.md) |
